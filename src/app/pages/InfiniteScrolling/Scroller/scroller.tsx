...
function ItemChild(props: any): ReactElement {
	...
	return <div ref={container}>{onRenderCell(item, itemIndex)}</div>
}
...
function Scroller(props: any) {
	...
	const createChild = (item: { [key: string]: any }, index: number) => {
		...
		return <ItemChild item={item} itemIndex={itemIndex} />
	}
	...
	return (
		<>
			<div ref={scrollContainer} className={styles['scroll-container']} style={{ height: scrollContainerHeight }} onScroll={onScroll}>
